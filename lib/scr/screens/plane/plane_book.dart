...
class PlaneBook extends StatefulWidget {
  @override
  _PlaneBookState createState() => _PlaneBookState();
}

class _PlaneBookState extends State<PlaneBook> {
  DateTime dateTime;
                                      ...
                                      return NumberOfTraveller(
                                        ...
                                        action: RaisedButton(
                                          ...
                                          onPressed: () {
                                            ...
                                            model.number = travelNum.toString();
                                          },
                                          child: Text('Submit'),
                                        ),
                                      );
                        ...
                        child: Center(
                          child: GestureDetector(
                            onTap: () async {
                              ...
                              print(model.number);
                              Result result = await model.getPlane();
